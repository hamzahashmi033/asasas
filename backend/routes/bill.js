...
router.post("/generateReport", auth.authenticate, (req, res) => {
    ...
    let query =
        "insert into bill (name, uuid, email, contactNumber, paymentMehtod, total, productDetails, createdBy) values(?,?,?,?,?,?,?,?)";
            ...
            if (!err) {
                ejs.renderFile(
                    path.join(__dirname, "", "report.ejs"),
                    {
                        ...
                        paymentMethod: orderDetails.paymentMehtod,
